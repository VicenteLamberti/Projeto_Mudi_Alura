...
public class PedidoController {
	...
	public String novo(@Valid RequisicaoNovoPedido requisicaoNovoPedido, BindingResult result) {
		...
		if(result.hasErrors()) {
			System.out.println("Formulário inválido, retornando novamente para o form mas sem limpar os campos preenchidos");
			return "pedido/formulario";
		}
		...
		System.out.println("Pedido salvo controller pedido");
